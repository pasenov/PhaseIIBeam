...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  fPBox1 =  new G4PVPlacement(myRotationDUT,			       //rotation
  ...
  fPBox2 =  new G4PVPlacement(myRotationDUT,			       //rotation
  ...
  G4double pos_EndArm1Abs = fInterArmDeltaZ/2;
  G4double pos_BeginningArm2Abs = fInterArmDeltaZ/2;
